...
def save(self, *args, **kwargs):
    ...
    - O tratamento pode permanecer ativo
      ...
      da mesma paciente.
    - Se não possuir dentista, utiliza o
...
class CondicaoOdontologica(models.Model):
    ...
    paciente = models.ForeignKey(
        ...
        related_name="condicoes_odontologicas"
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                ...
                name="unique_condicao_odontologica"
