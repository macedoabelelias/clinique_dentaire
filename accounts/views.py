...
def editar_paciente(request, id):
    ...
    if request.method == 'POST':
        ...
        if dentista_id:
            paciente.dentista_id = dentista_id
        else:
            paciente.dentista = None
    ...
    dentistas = User.objects.filter(
        is_active=True,
        perfil__perfil_acesso__nome='Dentista'
...
def odontograma(request, id):
    ...
    for item in itens_para_odontograma:
...
def orcamento(request, id):
    ...
    tratamento_id = (
        request.GET.get("tratamento")
        or request.POST.get("tratamento")
    )

    tratamento = None

    # =========================================
    # BUSCA TRATAMENTO INFORMADO
    # =========================================
    ...
    # =========================================
    #
    # Se nenhum tratamento foi selecionado,
    # prioriza o tratamento ATIVO mais recente.
    # =========================================
    ...
    # =========================================
    # SE NÃO EXISTIR TRATAMENTO ATIVO
    # =========================================
    ...
    # =========================================
    # SE O PACIENTE NÃO POSSUI TRATAMENTO
    # =========================================
    ...
    # =========================================
    # ORÇAMENTO DO TRATAMENTO SELECIONADO
    # =========================================
    ...
    if request.method == "POST":
        ...
        if "salvar_financeiro" in request.POST:
            ...
            print("=" * 60)
            print("SALVAR FINANCEIRO")
            print("PACIENTE:", paciente.id)
            print("TRATAMENTO:", tratamento.id)
            ...
            try:
                ...
                if orcamento.desconto < 0:
                    ...
                    return redirect(
                        f"/pacientes/{paciente.id}/orcamento/"
                        f"?tratamento={tratamento.id}"
                    )
                ...
                print(
                    "DENTISTA:",
                    tratamento.dentista.username
                    if tratamento.dentista
                    else None
                )
                print(
                    "ORÇAMENTO:",
    ...
    # =========================================
    # ITENS DO ORÇAMENTO SELECIONADO
    # =========================================
...
def editar_item_orcamento(request, id):
    ...
    if request.method == 'POST':
        ...
        valor_unitario = request.POST.get(
            'valor_unitario'
        )
...
@login_required
@permissao_required("aniversariantes", "visualizar")
...
@login_required
def converter_lead_paciente(request, pk):
    ...
    if lead.paciente:
        ...
        messages.info(
            request,
            'Este Lead já está cadastrado como paciente.'
        )
    ...
    HistoricoLead.objects.create(
        ...
        descricao=(
            f'Lead cadastrado como paciente. '
    ...
    messages.success(
        ...
        f'{paciente.nome} foi cadastrado como paciente com sucesso.'
